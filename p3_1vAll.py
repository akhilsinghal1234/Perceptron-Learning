...
import numpy
import sys
from classify import parameters,arg_max
...
def main():
	...
	for i in range(n):
		trainset = []
		trainset = generateData(files,i)
		perceptron_i[i].train(trainset)
		perceptron_i[i].file_index = i+1
		print(perceptron_i[i].file_index)
